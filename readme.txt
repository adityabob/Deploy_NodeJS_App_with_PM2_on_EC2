...
#this project is inspired by kastro kirans project
...
<head>
  ...
  <title>Welcome to Aditya's app</title>
  <style>
    body {
...
<body>
  ...
  <div class="content">
    ...
    <div class="about-me">
      <h2>About Me</h2>
      <p><strong>Name:</strong> Aditya Bobade V</p>
      <p><strong>Role:</strong> AWS & DevOps </p>
      <p><strong>Education:</strong> Engineering from Govt college of engineering Amravti</p>
    </div>
  ...
  <footer>
    <p>&copy; 2026 Aditya Bobade. All rights reserved.</p>
  </footer>
</body>
</html>
